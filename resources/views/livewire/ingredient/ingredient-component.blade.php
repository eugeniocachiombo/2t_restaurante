...
<div class="midde_cont">
    <div class="container-fluid">
            ...
            <div class="col">
                <div class="full counter_section margin_bottom_30 d-md-flex">
                    <div class="couter_icon">
                        <div><i class="fa fa-leaf green_color"></i></div> <!-- Ícone sugestão -->
                    </div>
                    <div class="counter_no">
                        <div>
                            <p class="total_no">{{ count($ingredients) }}</p>
                            <p class="head_couter">Ingredientes</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @include('livewire.ingredient.modal-add')
        @include('inc.footer')
    </div>
</div>
